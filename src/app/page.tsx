        ...
        <div className="h-screen bg-zinc-950 text-white flex overflow-hidden">
            ...
            `}
                    >
                        <div className={`
              w-10 h-10 rounded-lg flex items-center justify-center transition-all
              ${activeTab === "tools" ? "bg-emerald-500 text-black" : "bg-zinc-800 text-zinc-500 group-hover:bg-zinc-700"}
            `}>
                            <Wrench className="w-5 h-5" />
                        </div>
                        <div className="flex-1">
                            <span className="font-semibold block">{t.nav.tools}</span>
                            <span className="text-xs text-zinc-500">{t.nav.toolsDesc}</span>
                        </div>
